...
if __name__ =="__main__":
    ...
    save_path = "/home/zj-user/Icode/vis/data/NTU/figs/S013C001P027R002A028/pose"
    ...
    videowrite = cv2.VideoWriter(video_name,fourcc, 60.0,img_size_w_h,True)
    ...
    for i in range(frame_num):
        ...
        for j in range(person_num):
            ...
            img = add_joints( img_back,pose_coords_per_frame[j])
