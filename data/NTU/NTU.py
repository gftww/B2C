...
class NTU(torch.utils.data.Dataset):
    def __init__(self, data_split):
        ...
        self.data_path = osp.join('/back/dataset/HumanAction/', 'data', 'NTU', 'data')
        self.class_num = 60
        self.joint_num = 25
        ...
        self.skeleton = ((0,20), (20,3),(20,4),(4,5),(5,6),(20,8),(8,9),(9,10),(12,13),(13,14),(16,17),(17,18))
    ...
    def load_data(self):
        ...
        for aid in db.anns.keys():
            ...
            img_path = osp.join(self.data_path, 'frames', 'nturgbd_rgb_s' + str(setup_idx),'nturgb+d_rgb', str(img['file_name']))
